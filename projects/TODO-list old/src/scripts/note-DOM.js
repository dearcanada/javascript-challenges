import { notesList, mainElement } from "./shared/shared.js";
import { clearMainElement } from "./shared/processor.js";
export { renderGroupNotes };

const renderGroupNotes = (event, targetGroup) => {
  const target = event.target;
  if (target.closest('button')) return;
  clearMainElement();
  mainElement.appendChild(notesList);
